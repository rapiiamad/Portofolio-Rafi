  ...
  return (
    <>
      ...
      <main className="min-h-screen flex items-center bg-[#FEFEFE] flex-col">
        ...
        <Entrance>
          <section id="heading" className="mx-auto px-65 w-full flex flex-col md:flex-col items-center justify-between gap-10 py-80">

            {/* TEXT */}
            <div className="w-full">
              <h1 className="text-[64px] md:text-[64px] font-semibold leading-relaxed text-[#1E1E1E]">
                I’m Rafi — a frontend developer <span className="bg-gradient-to-r from-black/40 to-black/50 text-transparent bg-clip-text font-semibold"> who turns
        ...
        <section id="profile" className="mx-auto w-full px-65 flex flex-col md:flex-row items-end justify-center gap-5 py-50">

          <div className="w-fit flex flex-col items-end gap-2 pb-25">
            <div className="w-fit flex flex-row gap-[10px] items-center">
              <img
        ...
        <section id="profile" className="mx-auto w-full px-65 pb-50 flex flex-col md:flex-row justify-between">
          ...
          <div className="w-full flex flex-col items-start gap-2 pb-25">
             <div className="w-fit flex flex-row gap-[10px] items-center">
              <img
                        ...
                        className="w-[12px] h-[12px]"
                      />
              <p className="text-[#939393] mb-[1px] text-[16px]">Experience</p>
              </div>
            ...
            <h1 className="text-[#1E1E1E] text-[20px] my-[40px] font-medium">6 Month</h1>
          ...
          <div className="w-full flex flex-col items-start gap-2 pb-25">
             <div className="w-fit flex flex-row gap-[10px] items-center">
              <img
                        ...
                        className="w-[12px] h-[12px]"
                      />
              <p className="text-[#939393] mb-[1px] text-[16px]">Education</p>
              </div>
        ...
        <section id="skills" className="w-full px-65 flex flex-col items-center py-50">
          ...
          <div className="w-full flex flex-col items-center gap-2 pb-25">
             <div className="w-fit flex flex-row gap-[10px] items-center">
              <img
                        ...
                        className="w-[12px] h-[12px]"
                      />
              <p className="text-[#939393] mb-[1px] text-[16px]">Skills</p>
              </div>
          ...
          <div className="gap-[80px] w-full flex flex-col">
            <div className="w-full flex flex-col items-start gap-[60px]">
              <h1 className="text-2xl md:text-[20px] font-light leading-tight text-white text-right bg-[#1E1E1E] px-3">
                - Frontend</h1>
        ...
        <section id="projects" className="flex flex-col w-full px-65 py-50 gap-[80px]">
          <div className="flex flex-col w-full items-start">
             <div className="w-fit flex flex-row gap-[10px] items-center">
              <img
                        ...
                        className="w-[12px] h-[12px]"
                      />
              <p className="text-[#939393] mb-[1px] text-[16px]">My Projects</p>
              </div>
        ...
        <section id="contact" className="flex flex-row py-50 px-65 w-full justify-between gap-[40px] items-stretch">
          ...
          <div className="flex flex-col w-full justify-between">
            <div>
              ...
              <img
                        ...
                        className="w-[12px] h-[12px]"
                      />
              <p className="text-[#939393] mb-[1px] text-[16px]">Contact</p>
              </div>
          ...
          <form className="flex flex-col w-[660px] pt-[40px] gap-[15px]">
            ...
            <div className="w-[660px] flex flex-col gap-[10px]">
              ...
              <input
                ...
                type="text"
                className="bg-[#F0F0F0] p-5 rounded-sm focus:border-gray-600 outline-none text-[#363636] text-[16px]"
              />
            </div>
        ...
        <section id="footer" className="w-full flex flex-col pb-[100px] pt-[200px] items-center gap-[60px]">
